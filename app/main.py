...
def choose_hero():
    ...
    if request.method == "POST":
        ...
        player_unit = PlayerUnit(name=user_name, unit_class=unit_class, weapon=weapon_name, armor=armor_name)
...
def choose_enemy():
    ...
    if request.method == "POST":
        ...
        weapon_name = request.form.get("weapon_name")
        armor_name = request.form.get("armor_name")
        enemy_unit = EnemyUnit(name=user_name, unit_class=unit_class, weapon=weapon_name, armor=armor_name)
